...
public class DelegatedStencilElement extends StencilElement {
	...
	protected static final ElementRenderer DEFAULT_ELEMENT = (width, height, alpha) -> UIRenderHelper.angledGradient(0, -3, 5, height+4, width+6, new Color(0xff_10dd10).scaleAlpha(alpha), new Color(0xff_1010dd).scaleAlpha(alpha));
