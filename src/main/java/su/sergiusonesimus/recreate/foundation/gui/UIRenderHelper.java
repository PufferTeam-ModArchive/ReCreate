...
public class UIRenderHelper {
    ...
    private static void drawGradientRect(Tessellator tessellator, int left, int top, int right, int bottom, int color1,
        int color2) {
     ...
     * @see #angledGradient(MatrixStack, float, int, int, int, int, int, Color, Color)
     */
    public static void angledGradient(@Nonnull float angle, int x, int y, int z, int breadth, int length,
        Couple<Color> c) {
     ...
     * @see #angledGradient(MatrixStack, float, int, int, int, int, int, Color, Color)
     */
    public static void angledGradient(@Nonnull float angle, int x, int y, int breadth, int length, Color color1,
        Color color2) {
     ...
     */
    public static void angledGradient(float angle, int x, int y, int z, int breadth, int length, Color color1,
        Color color2) {
        GL11.glPushMatrix();
    ...
    public static void breadcrumbArrow(int x, int y, int z, int width, int height, int indent, Color startColor,
        Color endColor) {
        GL11.glPushMatrix();
    ...
    public static void drawColoredTexture(Color c, int x, int y, int z, float tex_left, float tex_top, int width,
        int height, int sheet_width, int sheet_height) {
        drawColoredTexture(
            c,
            x,
            x + width,
    ...
    private static void drawColoredTexture(Color c, int left, int right, int top, int bot, int z, int tex_width,
        int tex_height, float tex_left, float tex_top, int sheet_width, int sheet_height) {
        drawTexturedQuad(
            c,
            left,
            right,
    ...
    private static void drawTexturedQuad(Color c, int left, int right, int top, int bot, int z, float u1, float u2,
        float v1, float v2) {
        Tessellator tessellator = Tessellator.instance;
