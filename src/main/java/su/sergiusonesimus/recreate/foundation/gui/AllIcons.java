...
public class AllIcons implements ScreenElement {
	...
	public void bind() {
	    Minecraft.getMinecraft().getTextureManager().bindTexture(ICON_ATLAS);
	}
	...
	public DelegatedStencilElement asStencil() {
		return new DelegatedStencilElement().withStencilRenderer((w, h, alpha) -> this.render(0, 0)).withBounds(16, 16);
	}
