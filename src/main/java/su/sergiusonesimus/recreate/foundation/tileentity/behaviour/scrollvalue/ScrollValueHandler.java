...
public class ScrollValueHandler {
	...
	public static boolean onScroll(double delta) {
		...
		ScrollValueBehaviour scrolling = TileEntityBehaviour.get(world, objectMouseOver.blockX, objectMouseOver.blockY, objectMouseOver.blockZ, ScrollValueBehaviour.TYPE);
		if (scrolling == null)
			return false;
		if (!scrolling.isActive())
			return false;
		if (mc.thePlayer.isPlayerSleeping() || mc.thePlayer.isRiding())
			return false;
		//TODO
...
//			return false;
		...
		if (!scrolling.testHit(objectMouseOver.hitVec))
			return false;
