...
public class NBTHelper {
	...
	public static AxisAlignedBB readAABB(NBTTagList bbtag) {
		if (bbtag == null || bbtag.tagCount() == 0)
			return null;
		return AxisAlignedBB.getBoundingBox(bbtag.func_150308_e(0), bbtag.func_150308_e(1), bbtag.func_150308_e(2),
				bbtag.func_150308_e(3), bbtag.func_150308_e(4), bbtag.func_150308_e(5));
	}
