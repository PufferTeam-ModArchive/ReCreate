...
public class Color {
    ...
    public Color copy(boolean mutable) {
        if (mutable) return new Color(value);
        else return new Color(value).setImmutable();
    }
    ...
    public Color setRed(float r) {
        return ensureMutable().setRedUnchecked((int) (0xff * MathHelper.clamp_float(r, 0, 1)));
    }

    public Color setGreen(float g) {
        return ensureMutable().setGreenUnchecked((int) (0xff * MathHelper.clamp_float(g, 0, 1)));
    }

    public Color setBlue(float b) {
        return ensureMutable().setBlueUnchecked((int) (0xff * MathHelper.clamp_float(b, 0, 1)));
    }

    public Color setAlpha(float a) {
        return ensureMutable().setAlphaUnchecked((int) (0xff * MathHelper.clamp_float(a, 0, 1)));
    }
    ...
    public Color darker() {
        int a = getAlpha();
        return ensureMutable().mixWith(BLACK, .25f)
            .setAlphaUnchecked(a);
    }

    public Color brighter() {
        int a = getAlpha();
        return ensureMutable().mixWith(WHITE, .25f)
            .setAlphaUnchecked(a);
    }
