package su.sergiusonesimus.recreate.content.contraptions.components.actors;
...
public class BlockBreakingMovementBehaviour extends MovementBehaviour {
    ...
    // }
    // if (throwsEntities() && (world.isRemote == (entity instanceof Player))) {
    ...
    // NBTTagCompound data = context.data;
    // if (context.world.isRemote)
    // return;
