...
public class ShaftRenderBlock implements ISimpleBlockRenderingHandler {
    ...
    public boolean renderWorldBlock(IBlockAccess world, int x, int y, int z, Block block, int modelId,
    	...
    	if(mop == null || mop.typeOfHit != MovingObjectType.BLOCK || world.getBlock(mop.blockX, mop.blockY, mop.blockZ) != AllBlocks.shaft) return false;
    	
		model.setAxis(((ShaftBlock)block).getAxis(world.getBlockMetadata(mop.blockX, mop.blockY, mop.blockZ)));
