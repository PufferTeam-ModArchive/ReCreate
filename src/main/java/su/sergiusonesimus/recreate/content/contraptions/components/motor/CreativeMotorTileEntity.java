...
public class CreativeMotorTileEntity extends GeneratingKineticTileEntity {
	...
	public float getGeneratedSpeed() {
		if (this.getBlockType() != AllBlocks.creativeMotor)
			return 0;
		return convertToDirection(generatedSpeed.getValue(), ((CreativeMotorBlock)getBlockType()).getDirection(this.getBlockMetadata()));
	}
