...
public abstract class AbstractShaftBlock extends RotatedPillarKineticBlock implements IWrenchableWithBracket {
    ...
    public Optional<ItemStack> removeBracket(IBlockAccess world, int x, int y, int z, boolean inOnReplacedContext) {
        BracketedTileEntityBehaviour behaviour = TileEntityBehaviour
            .get(world, x, y, z, BracketedTileEntityBehaviour.TYPE);
        ...
        if (bracket == Blocks.air) return Optional.empty();
